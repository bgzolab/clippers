...
举例来说，去年我写过一个 "[四川大地震图片墙](https://www.ruanyifeng.com/php/earthquake/)"，它能动态显示关于四川地震的最新图片。但是，所有的图片都不是储存在我的服务器上，而是来自 [flickr.com](http://flickr.com/)。我只是发出一个动态请求，要求 flickr.com 向我提供图片。这种情况下，flickr.com 提供的就是一种 Web service。如果我把图片都存放在本地服务器，不调用 flickr.com，那么我就是在使用 " 本地服务 "。
