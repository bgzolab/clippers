...
aliases: check-if-email-exists
released: 2017-04-25T12:47:51Z
...
![](https://img.shields.io/github/stars/reacherhq/check-if-email-exists?style=for-the-badge&label=stars) ![](https://img.shields.io/github/repo-size/reacherhq/check-if-email-exists?style=for-the-badge&label=size) ![](https://img.shields.io/github/created-at/reacherhq/check-if-email-exists?style=for-the-badge&label=since)

[![](https://github-stats-extended.vercel.app/api/pin/?username=reacherhq&repo=check-if-email-exists&bg_color=00000000)](https://github.com/reacherhq/check-if-email-exists)
