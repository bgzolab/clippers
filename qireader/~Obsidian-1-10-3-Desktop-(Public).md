...
### New
  ...
  * Added ["Group by"](https://help.obsidian.md/bases/views#Sort+and+group+results) to group your data by the given property. Available in the "Sort menu."
  * Added [table summaries](https://help.obsidian.md/bases/views/table#Summaries). To use them, right-click a table column and choose "Summarize...". Choose from the list of built-in summary functions, or write your own.
  * Added new [List view](https://help.obsidian.md/bases/views/list) to display files as bulleted lists and numbered lists. Supports multi-line content and nested properties.
  * Added initial [Bases API](https://github.com/obsidianmd/obsidian-api/commit/359ffc30309077aa45954b9203fd30e5ac3da837).
  * Added new [Maps plugin](https://help.obsidian.md/bases/views/map) to visualize your base entries on a map. Install it from the Community plugins directory. This is an [official open source plugin](https://github.com/obsidianmd/obsidian-maps) that also provides an example of how developers can implement new view types for Bases.
...
All hotkeys are documented
[here](https://help.obsidian.md/bases/views/table#Shortcuts).
