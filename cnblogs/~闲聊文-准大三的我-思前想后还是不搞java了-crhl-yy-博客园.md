...
source: https://www.cnblogs.com/many-bucket/p/19009431
...
3.累。程序员是一个纯脑力活，在 ai 的帮助下 CURD 开发越来越少，一直要保持大脑的转动，在 ai 的帮助下，开发的交付周期一定会变短，需要更频繁的思考业务实现逻辑，设计模式的运用。其次，离开了工作你也需要一直学习，学习新技术，深入研究你使用的工具（各种包，插件，中间件）现在 ai 可以为你提供很大的学习广度，同时自学资源又太多，什么都可以学，故什么都得学（总有卷的人在逼你，不然就被优化掉）
...
ps：我认为还有一个原因是高精尖的技术，泛用性太小。而程序员在 common 的技能点上点不了多少，当程序员就是在把自己的现在和失业后的未来都换成钱，在现在的薪资阶梯下，我认为是不值当的。
