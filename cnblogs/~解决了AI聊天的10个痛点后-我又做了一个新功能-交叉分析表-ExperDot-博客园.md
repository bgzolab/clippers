...
source: https://www.cnblogs.com/experdot/p/18974641
...
不久前，我写了一篇文章《AI 聊天应用的 10 条高级需求》，吐槽了当前 Web 和桌面端 AI 聊天工具的 10 个体验问题。

[《AI 聊天应用的 10 条高级需求》](\"https://www.cnblogs.com/experdot/p/18924253\")

我的核心观点是：AI 聊天是值得我们深度挖掘的知识库。

光吐槽没用，坐而论道不如起而行。于是，我借助 AI 编程工具（我用 Cursor 辅助写代码，几乎完成了 90% 的工作量），把这些想法和需求，一点点变成了一个真实的应用，我给它取名叫 Pointer。
...
Pointer 项目本身就是这个理念的产物，它始于一个用户的个人需求，而我的探索也刚刚开始。

希望 Pointer 的这些思考和实践能给你带来一些启发。
